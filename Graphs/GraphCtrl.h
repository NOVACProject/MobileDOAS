...
public:
    ...
    /** Turns the showing of the Y-units and scale off */
    void HideYScale() { this->m_axisOptions.drawYUnits = false; }

    /** Turns the showing of the Y-units and scale on */
    void ShowYScale() { this->m_axisOptions.drawYUnits = true; }
