	...
	*/
	...
	public:
		...
		*/
		...
		/**
		* Calculates the alpha matrix and beta vector needed by the Levenberg Marquardt algorithm.
		*
	...
	private:
		/**
		* Contains the beta vector of the fit algorithm.
		*/
		CVector mBeta;
		/**
		* Contains the old beta vector of the fit algorithm.
		*/
		CVector mBetaOld;
		/**
