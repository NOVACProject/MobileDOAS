...
void CReferencePropertiesDlg::DoDataExchange(CDataExchange* pDX)
{
    ...
    if (m_ref != nullptr) {
        DDX_Text(pDX, IDC_EDIT_SPECIE, m_referenceName);
...
void CReferencePropertiesDlg::SaveData() {
    ...
    m_ref->m_specieName = std::string((LPCSTR)m_referenceName);
    m_ref->m_path = std::string((LPCSTR)m_referencePath);

    // save the shift option
    switch (m_shiftOption) {
    case 0: 
        m_ref->m_shiftOption = novac::SHIFT_TYPE::SHIFT_FREE;
        m_ref->m_shiftValue = 0.0;
        break;
    case 1:
        m_ref->m_shiftOption = novac::SHIFT_TYPE::SHIFT_FIX;
        m_ref->m_shiftValue = m_shiftFixValue;
        break;
    case 2:
        m_ref->m_shiftOption = novac::SHIFT_TYPE::SHIFT_LINK;
        m_ref->m_shiftValue = m_shiftLinkValue;
        break;
    case 3:
        m_ref->m_shiftOption = novac::SHIFT_TYPE::SHIFT_OPTIMAL;
        break;
    }
    ...
    case 0:
        m_ref->m_squeezeOption = novac::SHIFT_TYPE::SHIFT_FREE;
        m_ref->m_squeezeValue = 0.0;
        break;
    case 1:
        m_ref->m_squeezeOption = novac::SHIFT_TYPE::SHIFT_FIX;
        m_ref->m_squeezeValue = m_squeezeFixValue;
        break;
    case 2:
        m_ref->m_squeezeOption = novac::SHIFT_TYPE::SHIFT_LINK;
        m_ref->m_squeezeValue = m_squeezeLinkValue;
        break;
    case 3:
        m_ref->m_squeezeOption = novac::SHIFT_TYPE::SHIFT_OPTIMAL;
        break;
    }
}
...
void CReferencePropertiesDlg::UpdateDlg() {
    ...
    m_referenceName = m_ref->m_specieName.c_str();
    m_referencePath = m_ref->m_path.c_str();

    // TODO: There are multiple statements below which doesn't do anything. Figure out what they are intended to do and resolve.

    // save the shift option
    switch (m_ref->m_shiftOption) {
    case 0:
        novac::SHIFT_TYPE::SHIFT_FREE;
        m_shiftOption = 0;
        break;
    case 1:
        novac::SHIFT_TYPE::SHIFT_FIX;
        m_shiftOption = 1;
        m_shiftFixValue = m_ref->m_shiftValue;
        break;
    case 2:
        novac::SHIFT_TYPE::SHIFT_LINK;
        m_shiftOption = 2;
        m_shiftLinkValue = m_ref->m_shiftValue;
        break;
    case 3:
        novac::SHIFT_TYPE::SHIFT_OPTIMAL;
        m_shiftOption = 3;
        break;
    }
    ...
    case 1:
        ...
        m_squeezeOption = 1;
        break;
        m_squeezeFixValue = m_ref->m_squeezeValue;
        break;
    case 2:
        novac::SHIFT_TYPE::SHIFT_LINK;
        m_squeezeOption = 2;
        break;
        m_squeezeLinkValue = m_ref->m_squeezeValue;
        break;
    case 3:
        novac::SHIFT_TYPE::SHIFT_OPTIMAL;
        m_squeezeOption = 3;
...
void CReferencePropertiesDlg::BrowseForReference() {
    ...
    // 2. Set the path
    m_ref->m_path = std::string((LPCTSTR)fileName);

    // 3. make a guess of the specie name
    CString specie;
    Common::GuessSpecieName(fileName, specie);
    if (strlen(specie) != 0) {
        m_ref->m_specieName = std::string((LPCTSTR)specie);
    }
