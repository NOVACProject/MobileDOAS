...
void CReferencePropertiesDlg::SaveData(){
	...
	switch(m_shiftOption){
		...
		case 3: m_ref->m_shiftOption = SHIFT_OPTIMAL;			break;
	}
	...
	switch(m_squeezeOption){
		...
		case 3: m_ref->m_squeezeOption = SHIFT_OPTIMAL;			break;
	}
}
...
void CReferencePropertiesDlg::UpdateDlg(){
	...
	switch(m_ref->m_shiftOption){
		...
		case 3: SHIFT_OPTIMAL; m_shiftOption = 3; break;
	}
	...
	switch(m_ref->m_squeezeOption){
		...
		case 3: SHIFT_OPTIMAL; m_squeezeOption = 3; break;
	}
